...
return new class extends Migration {
  public function up(): void{Schema::create('mailing_lists', function (Blueprint $table) {// Primary key$table->id();
  ...
  public function down(): void{Schema::dropIfExists('mailing_lists');}
};